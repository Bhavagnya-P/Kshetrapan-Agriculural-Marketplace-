...
mysql -e "DROP USER IF EXISTS \x27Admin\x27@\x27localhost\x27;"\n\
mysql -e "CREATE USER \x27Admin\x27@\x27localhost\x27 IDENTIFIED WITH mysql_native_password BY \x27password\x27;"\n\
